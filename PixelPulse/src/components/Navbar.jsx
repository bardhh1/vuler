...
export default function Navbar() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed top-0 z-50 w-full px-2 pt-3 sm:px-6">
      <div className="glass-navbar mx-auto flex h-24 w-full max-w-7xl items-center justify-between rounded-2xl pl-2 pr-3 shadow-2xl sm:h-28 sm:px-6">
        ...
        <div className="relative flex items-center md:hidden">
          ...
          <div
            ref={menuRef}
            id="mobile-dropdown"
            className={`absolute right-0 top-20 z-50 min-w-44 rounded-xl border border-white/50 bg-white/90 p-2 shadow-xl backdrop-blur-xl transition-all duration-200 sm:top-24 ${
              isMenuOpen
